...
console.log('🚀 Deploying Medical App to Daytona Sandbox');
console.log('============================================');
...
try {
    ...
    // Create a simple setup script for the sandbox
...
`;
    ...
    fs.writeFileSync('setup-medical-app.sh', setupScript);
    
    console.log('📝 Setup script created: setup-medical-app.sh');
    console.log('');
    ...
    console.log('   - Upload setup-medical-app.sh to the sandbox');
    console.log('');
    console.log('4. 🔧 Run the setup script in the sandbox terminal:');
    console.log('   chmod +x setup-medical-app.sh');
    console.log('   ./setup-medical-app.sh');
    console.log('');
